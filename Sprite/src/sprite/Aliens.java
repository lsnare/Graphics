...
public class Aliens {
	...
	public void initTextures(){
		...
		tmap.createTexture("alienSpriteSheet.gif", "GIF", "alien");
	...
	private void renderSprite(){
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, tmap.getTextureID("alien"));
		GL11.glBegin(GL11.GL_QUADS);
		
			GL11.glTexCoord2f(deltaS * animIndex, 1f);
			GL11.glVertex3f(-0.02f, -0.02f, 0);
			GL11.glTexCoord2f(deltaS * (.81f+animIndex), 1f);
			GL11.glVertex3f( 0.02f, -0.02f, 0);
			GL11.glTexCoord2f(deltaS * (.81f+animIndex), 0f);
			GL11.glVertex3f( 0.02f,  0.02f, 0);
